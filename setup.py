...
if __name__ == '__main__':
    ...
    setup(
        ...
        ext_modules=[
            ...
            #     sources=['src/rbbox_overlaps_kernel.cu', 'src/rbbox_overlaps.pyx'])
            # make_cython_ext(
            #     name='rotated_nms',
            #     module='mmdet.ops.nms',
            #     sources=['src/rotated_cython_nms.pyx']),
            # make_cython_ext(
            #     name='rotated_overlap',
            #     module='mmdet.ops.nms',
            #     sources=['src/rotated_cython_overlap.pyx']),
            # make_cython_ext(
            #     name='soft_nms_cpu',
            #     module='mmdet.ops.nms',
            ...
            #     module='mmdet.ops.roi_align',
            #     sources=['src/rroi_align_cuda.cpp', 'src/rroi_align_kernel.cu']),
            # make_cuda_ext(
            #     name='roi_pool_cuda',
