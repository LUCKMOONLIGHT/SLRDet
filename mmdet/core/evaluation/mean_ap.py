...
def tpfp_imagenet(det_bboxes,
    ...
    Args:
        det_bbox (ndarray): the detected bbox [x,y,w,h,angle]
...
def eval_map(det_results,
    ...
    Args:
        det_results (list): a list of list, [[cls1_det, cls2_det, ...], ...] (0, 6)
        gt_bboxes (list): ground truth bboxes of each image, a list of K*5  (0, 5)
            array.
