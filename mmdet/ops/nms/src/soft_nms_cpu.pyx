        ...
        while pos < N:
            ...
            if iw > 0:
                ...
                if ih > 0:
                    ...
                    ov1 = iw * ih / area  # iou between max box and detection box
                    ov2 = iw * ih / (tx2 - tx1 + 1) * (ty2 - ty1 + 1)  # iou between max box and detection box

                    if method == 1:  # linear
                        if ov > iou_thr or ov1 > 0.95 or ov2 > 0.95:
                            weight = 1 - ov
                        else:
                            weight = 1
