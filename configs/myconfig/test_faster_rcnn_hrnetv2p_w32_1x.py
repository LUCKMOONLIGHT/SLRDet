...
# load_from = 'checkpoints/faster_rcnn_hrnetv2p_w32_1x_trainval_epoch_40.pth'
load_from = 'work_dirs/test_faster_rcnn_hrnetv2p_w32_1x/epoch_20.pth'
# load_from = 'checkpoints/epoch_50.pth'
resume_from = None
workflow = [('train', 1)]
