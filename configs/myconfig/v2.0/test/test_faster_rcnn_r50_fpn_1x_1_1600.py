...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.5, nms=dict(type='nms', iou_thr=0.5), max_per_img=2000)
...
log_level = 'INFO'
work_dir = './work_dirs/faster_rcnn_r50_fpn_1x_trainval_epoch_50'
load_from = 'checkpoints/faster_rcnn_r50_fpn_1x_noclip_trainval_epoch_50.pth'
resume_from = None
workflow = [('train', 1)]
