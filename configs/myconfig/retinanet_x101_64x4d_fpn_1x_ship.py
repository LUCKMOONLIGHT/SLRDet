...
test_cfg = dict(
    ...
    max_per_img=100)
# dataset settings
dataset_type = 'ODAIROTATEDShipCocoDataset'
data_root = 'data/ship/'
img_norm_cfg = dict(
...
log_level = 'INFO'
work_dir = 'work_dirs/retinanet_r101_1x_ship'
load_from = 'checkpoints/retinanet_x101_64x4d_fpn_1x_20181218-a0a22662.pth'
resume_from = None
workflow = [('train', 1)]
