...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.3, nms=dict(type='nms', iou_thr=0.5), max_per_img=300)
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(800, 800), (512, 512)], keep_ratio=True),
...
test_pipeline = [
    ...
    dict(
        ...
        img_scale=(512, 512),
        # img_scale=[(1024, 1024), (800, 800), (512, 512)],
        flip=False,
        transforms=[
...
log_level = 'INFO'
work_dir = 'work_dirs/faster_rcnn_hrnetv2p_w32_1x_libra_trainval'
load_from = 'checkpoints/rotated_faster_rcnn_hrnetv2p_w32_1x_trainval_epoch_40.pth'
resume_from = None
workflow = [('train', 1)]
